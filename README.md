...
Extracted from [filter](https://github.com/audiojs/filter). Magnitude-response *functions* (not filters) live in [a-weighting](https://github.com/audiojs/a-weighting) — absorb later as `.response(f)` per atom.
